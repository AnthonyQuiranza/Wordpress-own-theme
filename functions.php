<?php
function plz_assets(){
    //Agregar referencias link
    wp_register_style("google-font","https://fonts.googleapis.com/css2?family=Quicksand:wght@300;400;500;600;700", array(),false,'all');
    wp_register_style("google-font-s","https://fonts.googleapis.com/css2?family=Roboto:wght@100;400;500;700&display=swap", array(),false,'all');
...
function plz_theme_supports(){
    //Agregar titulo de pag dinamic
    add_theme_support("title-tag");
    //Agregar entrada destacada
...
function plz_add_menus(){
    register_nav_menus(
        array(
        'menu-principal' => "Principal menu",
        'menu-responsive' => "Resposive menu"
        )
    );
}
